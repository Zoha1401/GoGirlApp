...
export default function Login() { 
  ...
  return (
    ...
    <div className="mx-auto max-w-lg">
      <h1 className="text-center text-2xl font-bold text-indigo-600 sm:text-3xl">Connect, Learn, Grow!</h1>
      ...
      <form action="#" className="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8" onSubmit={handleClick}>
        ...
        <button
          type="submit"
          className="block w-full rounded-lg  bg-indigo-600 px-5 py-3 text-sm font-medium text-white loginBtn"
        >
          Log in
        </button>
